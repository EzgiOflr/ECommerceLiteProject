    ...
    public class HomeController : BaseController
    {
        ...
        public async Task<ActionResult> Buy()
        {
           ...
           $"<table><tr><th>Ürün Adı</th><th>Adet</th><th>Birim Fiyat</th><th>Toplam</th></tr>";
                        ...
                        Logger.LogMessage($" {user.Name} {user.Surname} {orderDetailList.Sum(x => x.TotalPrice)} " +
                            $"Liralik alışveriş yaptı.", "Home/Buy");
                        return RedirectToAction("Index" , "Home");
                    }
                    else
                    {
            ...
            {
                Logger.LogMessage($"Satın alma işleminde hata: " + ex.ToString(), "Home/Buy",
